...
public class AuthController {
    ...
    @PutMapping("/Partner/{username}")
    public ResponseEntity<?> UnVerify(@PathVariable String username){
        System.out.println("Adarsh dubey...................");
        return ResponseEntity.ok(partnerService.unVerifyRegistration(username));
    }
